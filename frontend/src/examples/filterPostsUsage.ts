// Example usage of the filter posts API (as a custom hook)
// mostly not exported, just for demonstration purposes - can be removed later !!
import { filterPostsController } from "@/controllers/postController/filterPosts";
import { useAccessToken } from "@/hooks/useAccessToken";

/**
 * useFilterPostsExamples
 * Call this hook from a React component to get example functions that use the access token.
 */
export const useFilterPostsExamples = () => {
