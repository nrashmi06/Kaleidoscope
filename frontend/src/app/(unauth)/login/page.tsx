...
export default function SignInPage() {
  return (
    <main className="flex flex-row h-screen w-full bg-cream-50 dark:bg-navy transition-colors duration-500">
      {/* Left side: Aurora visual background (client component) */}
      <div className="w-1/2 hidden md:block relative">
        <AuroraBackground className="absolute inset-0 w-full h-full">
          <div className="absolute inset-0 w-full h-full bg-transparent dark:bg-navy/80">
            <div className="absolute top-1/2 transform -translate-y-1/2 text-center w-full px-6">
              <div className="space-y-4">
                ...
                <TextGenerateEffect
                  ...
                  className="text-sm font-semibold text-steel/60 dark:text-sky/40"
                />
              </div>
            </div>
          </div>
