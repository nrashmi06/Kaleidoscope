...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen w-full bg-gray-50 dark:bg-neutral-950">
        {/* Top Navbar (Fixed) */}
        ...
        <div className="flex flex-1 pt-14 md:flex-row flex-col overflow-hidden w-full">
          ...
          <aside className="hidden md:flex md:w-72 flex-shrink-0 h-full">
            <div className="flex flex-col w-full h-full">
              <div className="sticky top-0 z-10 bg-gray-50 dark:bg-neutral-950 px-3 pt-4 pb-3 border-b border-gray-200 dark:border-neutral-800">
                <UserProfileCard />
              </div>
