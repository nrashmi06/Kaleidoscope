...
public interface UserTagApi {
    ...
    ResponseEntity<ApiResponse<PaginatedResponse<UserDetailsSummaryResponseDTO>>> getTaggableUsers(
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Unauthorized"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "User already tagged")
    })
    ResponseEntity<ApiResponse<UserTagResponseDTO>> createUserTag(
    ...
    ResponseEntity<ApiResponse<PaginatedResponse<UserTagResponseDTO>>> getTagsForContent(
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Tagged content retrieved successfully"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Unauthorized"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "User not found")
    })
    ResponseEntity<ApiResponse<PaginatedResponse<UserTagResponseDTO>>> getContentUserIsTaggedIn(
    ...
    ResponseEntity<ApiResponse<Object>> deleteTag(
