...
public interface UserBlockApi {
    ...
    ResponseEntity<AppResponse<UserBlockResponseDTO>> blockUser(
    ...
    ResponseEntity<AppResponse<String>> unblockUser(
    ...
    ResponseEntity<AppResponse<BlockedUsersListResponseDTO>> getBlockedUsers(
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Users who blocked you retrieved successfully",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = AppResponse.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized")
    })
    ResponseEntity<AppResponse<BlockedUsersListResponseDTO>> getUsersWhoBlockedMe(
            @Parameter(description = "Pagination information")
            @PageableDefault(size = 20) Pageable pageable);
    ...
    ResponseEntity<AppResponse<BlockStatusResponseDTO>> checkBlockStatus(
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "All blocks retrieved successfully",
                    content = @Content(mediaType = "application/json",
                            schema = @Schema(implementation = AppResponse.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Forbidden")
    })
    ResponseEntity<AppResponse<Page<UserBlockResponseDTO>>> getAllBlocks(
            @Parameter(description = "Pagination information")
            @PageableDefault(size = 20) Pageable pageable);
    ...
    ResponseEntity<AppResponse<String>> removeBlock(
